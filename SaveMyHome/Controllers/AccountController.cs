    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase Image = null)
        {
            if (ModelState.IsValid)
            {
                ...
                //если пользователь добавил фото, считываем массив байтов
                if (Image != null)
                {
                    user.ClientProfile.ImageMimeType = Image.ContentType;
                    user.ClientProfile.ImageData = new byte[Image.ContentLength];
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            if (user != null)
            {
                return View(new EditAccountViewModel
                {
                    ...
                    Hobbies = user.ClientProfile.Hobbies,
                    Skills = user.ClientProfile.Skills,
                    SecondPhoneNumber = user.ClientProfile.SecondPhoneNumber,
                    ImageData = user.ClientProfile.ImageData,
                    ImageMimeType = user.ClientProfile.ImageMimeType
                });
            }
            else
            {
        ...
        public async Task<ActionResult> Edit(EditAccountViewModel model, HttpPostedFileBase Image = null)
        {
            ...
            if (user != null)
            {
                ...
                user.ClientProfile.Age = model.Age;
                user.ClientProfile.ApartmentNumber = model.ApartmentNumber;
                user.ClientProfile.FirstName = model.FirstName;
                user.ClientProfile.LastName = model.LastName;
                user.ClientProfile.Hobbies = model.Hobbies;
                user.ClientProfile.Skills = model.Skills;
                user.ClientProfile.SecondPhoneNumber = model.SecondPhoneNumber;
